...
const Header = ({ meta, link }: any) => {
  ...
  const links: any[] = [
    { name: t('navigation.build'), href: "/build" },
    { name: t('navigation.playground'), href: "/" },
    // { name: t('navigation.gallery'), href: "/gallery" },
    // { name: t('navigation.dataExplorer'), href: "/explorer" },
  ];
          ...
          <DisclosurePanel className="md:hidden">
            ...
            <div className="mt-3 space-y-1 pb-2">
              ...
              <div className="px-3 py-2">
                <span className="text-sm text-secondary">{t('common.language')}</span>
                <div className="mt-1">
                  <LanguageSelector size="small" />
                </div>
              </div>
