    ...
    <div className="space-y-6">
      <DetailGroup title={t('teamBuilder.componentDetails')}>
        <div className="space-y-4">
          <label className="block">
            <span className="text-sm font-medium text-primary">{t('teamBuilder.componentName')}</span>
            <Input
              value={component.label || ""}
              onChange={(e) => handleComponentUpdate({ label: e.target.value })}
              placeholder={t('teamBuilder.componentNamePlaceholder')}
              className="mt-1"
            />
          </label>
          ...
          <label className="block">
            <span className="text-sm font-medium text-primary">
              {t('teamBuilder.componentDescription')}
            </span>
            <TextArea
              ...
              placeholder={t('teamBuilder.componentDescriptionPlaceholder')}
              rows={4}
              className="mt-1"
            />
          </label>
